...
public class CallFrm extends javax.swing.JFrame {
    private Client sourceinfo;
    private Client targetinfo;
    private Connect con;
    private Audio audio;
    ...
    public void TryConnect() {
                ...
                if (res == 1) {
                    con.sendClient(targetinfo);
                    res = con.rcvInt();
                    System.out.println("call2 " + res);
                    con.sendClient(sourceinfo);
                    res = con.rcvInt();
    ...
    public Client getSourceinfo() {
        return sourceinfo;
    }

    public void setSourceinfo(Client sourceinfo) {
        this.sourceinfo = sourceinfo;
    }

    public Client getTargetinfo() {
        return targetinfo;
    }

    public void setTargetinfo(Client targetinfo) {
